...
export class RemoteCatalogCollectionDetailError extends RemoteCatalogDetailError {
  constructor(
    id: string,
    resource: string,
    url: string,
    ...
    super(id, resource, url, message, cause);
    this.name = "RemoteCatalogCollectionDetailError";
  }
}
